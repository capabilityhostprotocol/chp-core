...
| OpenTelemetry | Trace/span/log/metric | Observability signals and distributed tracing. | Capability identity, invocation envelopes, denial semantics, replayable execution evidence. | Map CHP correlation to trace IDs and emit OTel spans/events from CHP evidence. |
